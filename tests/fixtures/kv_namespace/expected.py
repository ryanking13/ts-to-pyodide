...
class KVNamespace:
    ...
    async def get(self, key: str, options: KVNamespaceGetOptions | None = None) -> Any | None: ...
    @overload
    async def get(self, key: Any, type_: Literal["text"]) -> dict[str, str | None]: ...
    @overload
    async def get(self, key: Any, type_: Literal["json"]) -> dict[str, Any | None]: ...
    @overload
    async def get(self, key: Any, options: Any | None = None) -> dict[str, str | None]: ...
    @overload
    async def get(self, key: Any, options: KVNamespaceGetOptions | None = None) -> dict[str, str | None]: ...
    @overload
    async def get(self, key: Any, options: KVNamespaceGetOptions | None = None) -> dict[str, Any | None]: ...
    ...
    async def get_with_metadata(self, key: str, options: KVNamespaceGetOptions) -> KVNamespaceGetWithMetadataResult: ...
    @overload
    async def get_with_metadata(self, key: Any, type_: Literal["text"]) -> dict[str, KVNamespaceGetWithMetadataResult]: ...
    @overload
    async def get_with_metadata(self, key: Any, type_: Literal["json"]) -> dict[str, KVNamespaceGetWithMetadataResult]: ...
    @overload
    async def get_with_metadata(self, key: Any, options: Any | None = None) -> dict[str, KVNamespaceGetWithMetadataResult]: ...
    @overload
    async def get_with_metadata(self, key: Any, options: KVNamespaceGetOptions | None = None) -> dict[str, KVNamespaceGetWithMetadataResult]: ...
    @overload
    async def get_with_metadata(self, key: Any, options: KVNamespaceGetOptions | None = None) -> dict[str, KVNamespaceGetWithMetadataResult]: ...
    ...
    async def __getitem__(self, key: str, options: KVNamespaceGetOptions | None = None) -> Any | None: ...
    @overload
    async def __getitem__(self, key: Any, type_: Literal["text"]) -> dict[str, str | None]: ...
    @overload
    async def __getitem__(self, key: Any, type_: Literal["json"]) -> dict[str, Any | None]: ...
    @overload
    async def __getitem__(self, key: Any, options: Any | None = None) -> dict[str, str | None]: ...
    @overload
    async def __getitem__(self, key: Any, options: KVNamespaceGetOptions | None = None) -> dict[str, str | None]: ...
    @overload
    async def __getitem__(self, key: Any, options: KVNamespaceGetOptions | None = None) -> dict[str, Any | None]: ...
